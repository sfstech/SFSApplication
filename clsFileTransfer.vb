...
Public Class clsFileTransfer
    ...
    '*** A. subFileTransfer
    ''' <summary>
    ''' Simple system file copy from source to destination
    ''' </summary>
    ...
    Public Sub subFileTransferAction(ByVal strAction As String, ByVal intRowID As Integer, _
        ...
        '            strDestination:="I:\groups\sfs\invoices\ct\" & strFileNameFull, strCreateUser:=SystemInformation.UserName, dtCreateDate:=Format(System.DateTime.Now, "short date"))
        '***********************************************
        '***********************************************
    End Sub
