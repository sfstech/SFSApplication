...
Public Class clsIRMaster
    ...
    ''' <param name="intIRID"></param>
    ''' <param name="strInvoiceNumber"></param>
    ''' <param name="dtInvoiceDate"></param>
    ''' <param name="strCustomerName"></param>
    ''' <param name="strAddressLine1"></param>
    ''' <param name="strAddressLine2"></param>
    ''' <param name="strAddressLine3"></param>
    ...
    ''' <param name="dblTotInvoiceAmt"></param>
    ''' <param name="strGovernmentCode"></param>
    ''' <param name="strImportFileName"></param>
    ''' <param name="dtImportDate"></param>
    ''' <param name="strImportUser"></param>
    ''' <param name="strCPLoanNumber"></param>
    ''' <param name="strExportFileName"></param>
    ''' <param name="dtExportDate"></param>
    ''' <param name="strExportUser"></param>
    ''' <remarks></remarks>
    Public Sub subIRMasterSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal intIRID As Integer, ByVal strInvoiceNumber As String, ByVal dtInvoiceDate As Date, ByVal strCustomerName As String, _
                                 ...
                                 ByVal strExportFileName As String, ByVal dtExportDate As Date, ByVal strExportUser As String, ByVal SequenceIndicator As Integer)
        ...
        objDataAdapter.SelectCommand.Parameters.AddWithValue("@SequenceIndicator", SequenceIndicator)
        ...
        Select Case strBindTarget
            ...
            Case "frmSearch"
                ...
                SearchMenu.grdDataList.DataMember = "dsIRMaster"
            Case "frmSearchIRDept"
                SearchMenu.grdDataList.DataSource = objDataSet
                SearchMenu.grdDataList.DataMember = "dsIRMaster"
                SearchMenu.grdDataList.Columns("DeptName").Width = 350
            Case "frmIRBudgetcbo"
            ...
            Case "frmSearch-Pmt"
                SearchMenu.grdDataList.DataSource = objDataSet
                SearchMenu.grdDataList.DataMember = "dsIRMaster"
                SearchMenu.grdDataList.Columns("InvoiceNumber").Width = 85
                SearchMenu.grdDataList.Columns("Budget").Width = 60
                SearchMenu.grdDataList.Columns("Rev Code").Width = 60
                SearchMenu.grdDataList.Columns("Tran Date").Width = 65
                SearchMenu.grdDataList.Columns("Tran Date").DefaultCellStyle.Format = "MM/dd/yy"
                SearchMenu.grdDataList.Columns("CT Date").Width = 65
                SearchMenu.grdDataList.Columns("CT Date").DefaultCellStyle.Format = "MM/dd/yy"
                SearchMenu.grdDataList.Columns("Principal").Width = 100
                SearchMenu.grdDataList.Columns("Principal").DefaultCellStyle.Format = "c"
                SearchMenu.grdDataList.Columns("Principal").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
                SearchMenu.grdDataList.Columns("Interest").Width = 90
                SearchMenu.grdDataList.Columns("Interest").DefaultCellStyle.Format = "c"
                SearchMenu.grdDataList.Columns("Interest").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
                SearchMenu.grdDataList.Columns("Tax").Width = 80
                SearchMenu.grdDataList.Columns("Tax").DefaultCellStyle.Format = "c"
                SearchMenu.grdDataList.Columns("Tax").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
                SearchMenu.grdDataList.Columns("Late Charge").Width = 80
                SearchMenu.grdDataList.Columns("Late Charge").DefaultCellStyle.Format = "c"
                SearchMenu.grdDataList.Columns("Late Charge").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
                SearchMenu.grdDataList.Columns("Invoice Amt").Width = 80
                SearchMenu.grdDataList.Columns("Invoice Amt").DefaultCellStyle.Format = "c"
                SearchMenu.grdDataList.Columns("Invoice Amt").DefaultCellStyle.Alignment = DataGridViewContentAlignment.MiddleRight
                SearchMenu.grdDataList.Columns("Customer").Width = 200
                SearchMenu.grdDataList.Columns("Department").Width = 200
    ...
    Public Sub subIRMasterAction(ByVal strAction As String, ByVal intIRID As Integer, ByVal strInvoiceNumber As String, ByVal dtInvoiceDate As Date, ByVal strCustomerName As String, _
        ...
        objCommand.Parameters.AddWithValue("@SequenceIndicator", SequenceIndicator)
