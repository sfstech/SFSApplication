    ...
    ByVal strStatus As String, ByVal strCreateUser As String, ByVal dtCreateDate As Date)
        ...
        Select Case strBindTarget
            Case "frmSearch"
                ...
                SearchMenu.grdDataList.DataMember = "dsStaff"

                'Setup form title...
                SearchMenu.Text = "Staff Search"
                ...
                SearchMenu.grdDataList.Columns(5).Width = 150
                SearchMenu.grdDataList.Columns(6).Width = 180
                SearchMenu.grdDataList.Columns(7).Width = 180
                ...
                SearchMenu.grdDataList.Columns(5).HeaderText = "Area"
                SearchMenu.grdDataList.Columns(6).HeaderText = "Position"
                SearchMenu.grdDataList.Columns(7).HeaderText = "Hours"
