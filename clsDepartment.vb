    ...
    ByVal strprocess_type As String, ByVal strprocess_type_desc As String, ByVal strterminal_status As String, ByVal strstatement_pref As String)
        ...
        Select Case strBindTarget
            Case "frmSearch"
                ...
                SearchMenu.grdDataList.DataMember = "dsDepartment"

                'Setup form title...
                SearchMenu.Text = "Select Department"
                ...
                'Setup column widths...
                SearchMenu.grdDataList.Columns(0).Width = 50
                SearchMenu.grdDataList.Columns(1).Width = 250
                SearchMenu.grdDataList.Columns(2).Visible = False
                SearchMenu.grdDataList.Columns(3).Visible = False

                'Setup column headers...
                SearchMenu.grdDataList.Columns(0).HeaderText = "Dept ID"
                SearchMenu.grdDataList.Columns(1).HeaderText = "Department"
