    ...
    Private Sub frmBankData_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        Select Case frmMainMenu.txtModule.Text
            ...
            Case "BofA-SEARCH-0904"
                ...
                strCreateUser:="NONE", dtCreateDate:="01/01/1900")
            Case "BofA-SEARCH-6747"
                objBankData = New clsBankData
                Call objBankData.subBofASelect(strBindTarget:="frmBankData", strAction:="BofA-SELECT-DATE", dtBankDate:=frmMainMenu.txtActionID.Text, intAcctNum:="10426747", _
                strCreateUser:="NONE", dtCreateDate:="01/01/1900")
            Case "BofA-SEARCH-6750"
                objBankData = New clsBankData
                Call objBankData.subBofASelect(strBindTarget:="frmBankData", strAction:="BofA-SELECT-DATE", dtBankDate:=frmMainMenu.txtActionID.Text, intAcctNum:="10426750", _
                strCreateUser:="NONE", dtCreateDate:="01/01/1900")
            Case "BofA-SEARCH-0800"
                objBankData = New clsBankData
                Call objBankData.subBofASelect(strBindTarget:="frmBankData", strAction:="BofA-SELECT-DATE", dtBankDate:=frmMainMenu.txtActionID.Text, intAcctNum:="22140800", _
                strCreateUser:="NONE", dtCreateDate:="01/01/1900")
