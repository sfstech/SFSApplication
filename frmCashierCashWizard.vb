Public Class frmCashierCashWizard
    ...
    Private Sub subFormatScreen()
        If frmMainMenu.strCallingForm = "Cashier Balancing" Then
            ...
            Me.txtCashLink.Visible = False
            Me.Label4.Visible = False
            Me.txtTotAmtOnHand.Visible = False
        Else
            ...
            Me.txtPOP.Visible = True
            Me.Label3.Visible = True
            Me.txtCashLink.Visible = True
            Me.Label4.Visible = True
            Me.txtTotAmtOnHand.Visible = True
        End If
    End Sub
    ...
    Private Sub subGetCashierActivityAmounts()
        ...
        If frmMainMenu.strCallingForm = "Cashier Balancing" Then
            ...
            'Me.txtCashLink.Text = frmCashierBalancing.txtlCashLink.Text
            'Me.txtPOP.Text = frmCashierBalancing.txtPoPVirtualMerch.Text
            'Me.txtCheck.Text = frmCashierBalancing.txtManualCheck.Text
            'Me.txtNetCash.Text = frmCashierBalancing.txtCash.Text
            'Me.txtChangeFund.Text = frmCashierBalancing.txtCash.Text
        Else
