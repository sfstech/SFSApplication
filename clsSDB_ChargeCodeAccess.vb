    ...
    Public Sub subChargeCodeAccessSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal intRowID As Integer, ByVal strRequesterSDBLogin As String, _
        ...
        Select Case strBindTarget
            Case "frmSearch"
                ...
                SearchMenu.grdDataList.DataMember = "dsChargeCodeAccess"

                'Setup form title...
                SearchMenu.Text = "ChargeCodeAccess Data Search"
                ...
                SearchMenu.grdDataList.Columns(8).HeaderText = "ChargeCode1"
                SearchMenu.grdDataList.Columns(9).HeaderText = "ChargeCode2"
                SearchMenu.grdDataList.Columns(10).HeaderText = "ChargeCode3"
                SearchMenu.grdDataList.Columns(11).HeaderText = "ChargeCode4"
                SearchMenu.grdDataList.Columns(12).HeaderText = "ChargeCode5"
                SearchMenu.grdDataList.Columns(13).HeaderText = "ChargeCode6"
                SearchMenu.grdDataList.Columns(14).HeaderText = "ChargeCode7"
                SearchMenu.grdDataList.Columns(15).HeaderText = "ChargeCode8"
                SearchMenu.grdDataList.Columns(16).HeaderText = "ChargeCode9"
                SearchMenu.grdDataList.Columns(17).HeaderText = "ChargeCode10"
