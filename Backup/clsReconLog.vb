    ...
    Public Sub subReconLogSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal intRowID As Integer, ByVal strReconType As String, ByVal strReconDesc As String, ByVal strMonth As String, ByVal strQuarter As String, ByVal intYear As Integer, ByVal strReconciler As String, ByVal dtStartDate As Date, ByVal dtStopDate As Date, ByVal intNumRecItems As Integer, ByVal intSumRecItems As Integer, ByVal strCreatedUser As String, ByVal dtCreatedDate As Date, ByVal strApproveUser As String, ByVal dtApproveDate As Date, ByVal strFilePath As String)
        ...
        Select Case strBindTarget
            Case "frmSearch"
                ...
                frmSearch.grdDataList.DataMember = "dsReconLog"

                'Setup form title...
                frmSearch.Text = "Recon Log Search"
                ...
                frmSearch.grdDataList.Columns(3).Width = 65
                frmSearch.grdDataList.Columns(4).Width = 55
                frmSearch.grdDataList.Columns(5).Width = 45
                ...
                frmSearch.grdDataList.Columns(9).Width = 40
                frmSearch.grdDataList.Columns(10).Width = 60
                frmSearch.grdDataList.Columns(11).Width = 65
                frmSearch.grdDataList.Columns(12).Width = 65
                frmSearch.grdDataList.Columns(13).Visible = False
                frmSearch.grdDataList.Columns(14).Visible = False
                frmSearch.grdDataList.Columns(15).Width = 65

                'Setup column headers...
                frmSearch.grdDataList.Columns(1).HeaderText = "Type"
                frmSearch.grdDataList.Columns(2).HeaderText = "Description"
                frmSearch.grdDataList.Columns(3).HeaderText = "Month"
                frmSearch.grdDataList.Columns(4).HeaderText = "Quarter"
                frmSearch.grdDataList.Columns(5).HeaderText = "Year"
                frmSearch.grdDataList.Columns(9).HeaderText = "Count"
                frmSearch.grdDataList.Columns(10).HeaderText = "Amount"
                frmSearch.grdDataList.Columns(11).HeaderText = "Prepared By"
                frmSearch.grdDataList.Columns(12).HeaderText = "Prepared On"
                frmSearch.grdDataList.Columns(15).HeaderText = "File Path"
