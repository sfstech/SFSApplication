    ...
    Public Sub subWEBCCSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal strStudentID As String, ByVal strLName As String, ByVal strFName As String, ByVal intClass As Integer, ByVal strMajor As String, ByVal strBranch As String, ByVal strPath As String, ByVal strxLevel As String, ByVal amtCredit As Double, ByVal amtDebit As Double, ByVal strTransDate As String, ByVal strTransCode As String, ByVal strConfirmationNum As String, ByVal strWebUser As String, ByVal strImportFileName As String, ByVal strImportUser As String, ByVal strImportDate As String)
        ...
        Select Case strBindTarget
            ...
            Case "frmSearch-By-TranDate"
                ...
                frmSearch.grdDataList.DataMember = "dsWEBCC"

                'Setup form title...
                frmSearch.Text = "Select Extract Data"
                ...
                'Setup column widths...
                frmSearch.grdDataList.Columns(0).Width = 60
                frmSearch.grdDataList.Columns(1).Width = 40
                frmSearch.grdDataList.Columns(2).Width = 65
                frmSearch.grdDataList.Columns(3).Width = 65
                frmSearch.grdDataList.Columns(4).Width = 65
                frmSearch.grdDataList.Columns(5).Width = 125
                frmSearch.grdDataList.Columns(6).Width = 60
                frmSearch.grdDataList.Columns(7).Width = 60

                'Setup column headers...
                frmSearch.grdDataList.Columns(0).HeaderText = "Tran Date"
                frmSearch.grdDataList.Columns(1).HeaderText = "# of Tran"
                frmSearch.grdDataList.Columns(2).HeaderText = "Credits"
                frmSearch.grdDataList.Columns(3).HeaderText = "Debits"
                frmSearch.grdDataList.Columns(4).HeaderText = "Total"
                frmSearch.grdDataList.Columns(5).HeaderText = "File Name"
                frmSearch.grdDataList.Columns(6).HeaderText = "Imported By"
                frmSearch.grdDataList.Columns(7).HeaderText = "Import Date"
