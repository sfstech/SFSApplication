...
Public Class clsExport
    ...
    Public Sub subCTSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal strModule As String, ByVal strFileName As String, ByVal strUserName As String, ByVal dtCreateDate As Date)
        ...
        Select Case strBindTarget
            ...
            Case "frmSearch"
                ...
                frmSearch.grdDataList.DataMember = "dsCashTransmittal"

                'Setup form title...
                frmSearch.Text = "CT Search"
                ...
                frmSearch.grdDataList.Columns(0).HeaderText = "File Name"
                frmSearch.grdDataList.Columns(1).HeaderText = "Module"
                frmSearch.grdDataList.Columns(2).HeaderText = "Amount"
                frmSearch.grdDataList.Columns(3).HeaderText = "Create User"
                frmSearch.grdDataList.Columns(4).HeaderText = "Create Date"
                frmSearch.grdDataList.Columns(5).HeaderText = "FAS Ver Date"
    ...
    Public Sub subSDBSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal intID As Integer, ByVal strFileName As String, ByVal strUserName As String)
        ...
        Select Case strBindTarget
            Case "frmSearch"
                'Set the DataGridView properties to bind it to the data...
                frmSearch.grdDataList.DataSource = objDataSet
                frmSearch.grdDataList.DataMember = "dsSDBExport"

                'Setup form title...
                frmSearch.Text = "SDB Export Search"
                ...
                'Setup column widths...
                frmSearch.grdDataList.Columns(0).Visible = 80
                frmSearch.grdDataList.Columns(1).Visible = 80
                frmSearch.grdDataList.Columns(2).Width = 80
                frmSearch.grdDataList.Columns(3).Width = 80
                frmSearch.grdDataList.Columns(4).Width = 80
                frmSearch.grdDataList.Columns(5).Width = 80
                ...
                frmSearch.grdDataList.Columns(3).HeaderText = "Create User"
                frmSearch.grdDataList.Columns(4).HeaderText = "Create Date"
                frmSearch.grdDataList.Columns(5).HeaderText = "SDB Ver User"
    ...
    Public Function fncGetCTBatchNumber(ByVal strModule As String) As Integer
        ...
        Else
            ...
            '            MyTable = dsGetBatchNum.Tables(0)
