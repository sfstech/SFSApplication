    ...
    Public Sub subStaffActivitySelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal intRowID As Integer, ByVal strUnit As String, ByVal strRequestor As String, ByVal strAssignee As String, ByVal strDescription As String, ByVal dtStartDate As Date, ByVal dtStopDate As Date, ByVal strType As String, ByVal strPriority As String, ByVal strStatus As String, ByVal strReferral As String, ByVal strNotes As String, ByVal strContactMethod As String, ByVal strCreatedBy As String, ByVal dtCreateDate As Date)
        ...
        Select Case strBindTarget
            ...
            Case "frmSearch"
                ...
                frmSearch.grdDataList.DataMember = "dsStaffActivity"

                'Setup form title...
                frmSearch.Text = "Staff Activity Search"
                ...
                frmSearch.grdDataList.Columns(3).Width = 75
                frmSearch.grdDataList.Columns(4).Width = 75
                frmSearch.grdDataList.Columns(5).Visible = False
                frmSearch.grdDataList.Columns(6).Visible = False
                frmSearch.grdDataList.Columns(7).Width = 75
                frmSearch.grdDataList.Columns(8).Width = 75
                frmSearch.grdDataList.Columns(9).Width = 75
                frmSearch.grdDataList.Columns(10).Visible = False
                frmSearch.grdDataList.Columns(11).Visible = False
                frmSearch.grdDataList.Columns(12).Visible = False
                ...
                frmSearch.grdDataList.Columns(1).HeaderText = "Unit"
                frmSearch.grdDataList.Columns(2).HeaderText = "Requestor"
                frmSearch.grdDataList.Columns(3).HeaderText = "Assignee"
                frmSearch.grdDataList.Columns(4).HeaderText = "Desc"
                frmSearch.grdDataList.Columns(7).HeaderText = "Type"
                frmSearch.grdDataList.Columns(9).HeaderText = "Status"
