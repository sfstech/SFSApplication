    ...
    Public Sub subCashierDetSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal intCashierTranID As Integer, _
        ...
        Select Case strBindTarget
            ...
            Case "frmSearch"
                ...
                frmSearch.grdDataList.DataMember = "dsCashierDet"
                'Setup form title...
                frmSearch.Text = "Cashier Data Search by Amount"
                'Setup column description,  widths and format ...
                frmSearch.grdDataList.Columns(0).Visible = False
                frmSearch.grdDataList.Columns(1).HeaderText = "TranDate"
                ...
                frmSearch.grdDataList.Columns(4).HeaderText = "Cashier Name"
                frmSearch.grdDataList.Columns(4).Width = 180
                ...
                frmSearch.grdDataList.Columns(11).HeaderText = "Type"
                frmSearch.grdDataList.Columns(11).Width = 180
                frmSearch.grdDataList.Columns(12).HeaderText = "Amount"
                frmSearch.grdDataList.Columns(12).Width = 95
