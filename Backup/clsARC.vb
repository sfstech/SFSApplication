    ...
    Public Sub subARCExternalSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal strBatchID As String, ByVal strTransmissionDepositID As String, ByVal strBankNumber As String, ByVal strAccountNum As String, ByVal strCheckNumber As String, ByVal dblAmount As Double, ByVal strTransactionType As String, ByVal dtRecdDate As Date, ByVal strCreateUser As String, ByVal dtCreateDate As Date)
        ...
        Select Case strBindTarget
            ...
            Case "frmSearch-All"
                ...
                frmSearch.grdDataList.DataMember = "dsARCExternal"

                'Setup form title...
                frmSearch.Text = "Select US Bank Data"
                ...
                'Setup column widths...
                frmSearch.grdDataList.Columns(0).Width = 230
                frmSearch.grdDataList.Columns(1).Width = 68
                frmSearch.grdDataList.Columns(2).Width = 58
                frmSearch.grdDataList.Columns(3).Width = 58
                frmSearch.grdDataList.Columns(4).Width = 58
                frmSearch.grdDataList.Columns(5).Width = 68

                'Setup column headers...
                frmSearch.grdDataList.Columns(0).HeaderText = "Transmission Deposit ID"
                frmSearch.grdDataList.Columns(1).HeaderText = "Rec'd Date"
                frmSearch.grdDataList.Columns(2).HeaderText = "Count"
                frmSearch.grdDataList.Columns(3).HeaderText = "Amount"
                frmSearch.grdDataList.Columns(4).HeaderText = "Imported By"
                frmSearch.grdDataList.Columns(5).HeaderText = "Import Date"
    ...
    Public Sub subARCInternalSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal strBatchID As String, ByVal strBankNumber As String, ByVal strAccountNum As String, ByVal strCheckNumber As String, ByVal dblAmount As Double, ByVal strTransactionType As String, ByVal dtCaptureTime As Date, ByVal strCreateUser As String, ByVal dtCreateDate As Date)
        ...
        Select Case strBindTarget
            ...
            Case "frmSearch-All"
                'Set the DataGridView properties to bind it to the data...
                frmSearch.grdDataList.DataSource = objDataSet
                frmSearch.grdDataList.DataMember = "dsARCInternal"

                'Setup form title...
                frmSearch.Text = "Select ACH Terminal Data"
                ...
                'Setup column headers...
                frmSearch.grdDataList.Columns(0).HeaderText = "Batch ID"
                frmSearch.grdDataList.Columns(1).HeaderText = "Capture Date"
                frmSearch.grdDataList.Columns(2).HeaderText = "Count"
                frmSearch.grdDataList.Columns(3).HeaderText = "Amount"
                frmSearch.grdDataList.Columns(4).HeaderText = "Imported By"
                frmSearch.grdDataList.Columns(5).HeaderText = "Import Date"
