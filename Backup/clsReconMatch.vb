...
Public Class clsReconMatch
   ...
   ByVal dtStartDate As Date, ByVal dtEndDate As Date, ByVal strCreateUser As String)
    ...
    Private Sub subGETUWSDBDataset2()
        ...
        Dim objConnection As New SqlConnection("Data Source=SDBSQLC1DB1.admin.washington.edu;Initial Catalog=UWSDB;User Id=sfstech;Password=fJNaCh7A;Trusted_Connection=True;")
