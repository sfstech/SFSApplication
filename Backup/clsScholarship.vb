    ...
    Public Sub subScholarshipSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal intScholarshipID As Integer, _
        ...
        Select Case strBindTarget
            ...
            Case "frmSearch-Schol-Detail"
                ...
                frmSearch.grdDataList.DataMember = "dsScholarship"
                ...
                frmSearch.grdDataList.Columns(2).Width = 65
                frmSearch.grdDataList.Columns(2).Visible = False
                frmSearch.grdDataList.Columns(3).Width = 180
                frmSearch.grdDataList.Columns(4).Width = 65
                frmSearch.grdDataList.Columns(5).Width = 30
                frmSearch.grdDataList.Columns(6).Width = 40
                frmSearch.grdDataList.Columns(7).Width = 85 '125
                frmSearch.grdDataList.Columns(8).Width = 50

                frmSearch.grdDataList.Columns(9).DefaultCellStyle.Format = "c"
                frmSearch.grdDataList.Columns(1).DefaultCellStyle.Format = "0000000"
                frmSearch.intRecCount = frmSearch.grdDataList.RowCount
            ...
            Case "frmSearch-RoomBoard-Update"
                ...
                'Setup form title...
                frmSearch.Text = "Room and Board Update"
                ...
                'Setup column widths...
                frmSearch.grdDataList.Columns(0).Width = 65 ' Stno
                frmSearch.grdDataList.Columns(1).Width = 65
                frmSearch.grdDataList.Columns(2).Width = 30
                frmSearch.grdDataList.Columns(3).Width = 37
                frmSearch.grdDataList.Columns(4).Width = 70
                frmSearch.grdDataList.Columns(5).Width = 100
                frmSearch.grdDataList.Columns(6).Width = 65 ' amount
                frmSearch.grdDataList.Columns(7).Width = 65
                frmSearch.grdDataList.Columns(8).Width = 65
                frmSearch.grdDataList.Columns(9).Width = 65

                frmSearch.grdDataList.Columns(0).DefaultCellStyle.Format = "0000000"
                frmSearch.grdDataList.Columns(6).DefaultCellStyle.Format = "c"
