    ...
    Public Sub subEsignatureSelect(ByVal strBindTarget As String, ByVal strAction As String, _
        ...
        Select Case strBindTarget
            Case "frmSearch"
                ...
                frmSearch.grdDataList.DataMember = "dsEsignature"

                'Setup form title...
                frmSearch.Text = "Select eMPN Data"
                ...
                'Setup column widths...
                frmSearch.grdDataList.Columns(0).Width = 80
                ...
                frmSearch.grdDataList.Columns(1).HeaderText = "Import User"
