    ...
    Public Sub subReconLogMasterSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal intReconLogMasterID As Integer, ByVal strReconType As String, ByVal strReconDesc As String, ByVal strReconLevel As String, ByVal strReconciler As String, ByVal strFrequency As String)
        ...
        Select Case strBindTarget
            Case "frmSearch"
                ...
                frmSearch.grdDataList.DataMember = "dsReconLogMaster"

                'Setup form title...
                frmSearch.Text = "Recon Log Master Data Search"
                ...
                frmSearch.grdDataList.Columns(1).Width = 75
                frmSearch.grdDataList.Columns(2).Width = 75
                ...
                frmSearch.grdDataList.Columns(3).HeaderText = "Level"
                frmSearch.grdDataList.Columns(4).HeaderText = "Reconciler"
