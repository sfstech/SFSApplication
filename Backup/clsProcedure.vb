    ...
    Public Sub subProcedureSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal intProcedureID As Integer, ByVal strModule As String, ByVal strCategory As String, ByVal strDescription As String, ByVal strFilePath As String, _
        ...
        Select Case strBindTarget
            Case "frmSearch"
                ...
                frmSearch.grdDataList.DataMember = "dsProc"
                ...
                frmSearch.grdDataList.Columns(3).Width = 250
                frmSearch.grdDataList.Columns(4).Width = 100

                frmSearch.grdDataList.Columns(5).Width = 100
                frmSearch.grdDataList.Columns(6).Width = 100
                frmSearch.grdDataList.Columns(7).Width = 100
                frmSearch.grdDataList.Columns(8).Width = 100
