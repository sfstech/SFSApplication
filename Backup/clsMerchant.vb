    ...
    ByVal strExpProject As String, ByVal strStatus As String, ByVal intDeptID As Integer, ByVal dtLastSurveyDate As Date)
        ...
        Select Case strBindTarget
            Case "frmMerchants"
                ...
                frmSearch.grdDataList.DataMember = "dsMerchant"
            ...
            Case "frmSearch"
                ...
                'Setup form title...
                frmSearch.Text = "Select Merchant"
                ...
                frmSearch.grdDataList.Columns(2).Width = 70
                frmSearch.grdDataList.Columns(3).Width = 200
                frmSearch.grdDataList.Columns(4).Width = 55
                frmSearch.grdDataList.Columns(5).Width = 55
                frmSearch.grdDataList.Columns(6).Width = 65
                frmSearch.grdDataList.Columns(7).Width = 55
                frmSearch.grdDataList.Columns(8).Width = 85
                frmSearch.grdDataList.Columns(9).Width = 80

                '  frmMerchants.gridMerchants.Columns(0).HeaderText = "Merchant ID"
                '  frmMerchants.gridMerchants.Columns(1).HeaderText = "DeptID"
                frmSearch.grdDataList.Columns(2).HeaderText = "Merchant"
                frmSearch.grdDataList.Columns(3).HeaderText = "Department"
                frmSearch.grdDataList.Columns(4).HeaderText = "Revenue"
                frmSearch.grdDataList.Columns(5).HeaderText = "Expense"
                frmSearch.grdDataList.Columns(6).HeaderText = "Processing Type"
                frmSearch.grdDataList.Columns(7).HeaderText = "First"
                frmSearch.grdDataList.Columns(8).HeaderText = "Last"
                frmSearch.grdDataList.Columns(9).HeaderText = "Last Survey"
