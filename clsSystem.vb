...
Public Class clsSystem
    ...
    ByVal dtPasswordDate As Date, ByVal strStatus As String, ByVal strCreateUser As String, ByVal dtCreateDate As Date)
        ...
        Select Case strBindTarget
            ...
            Case "frmSearch"
                ...
                SearchMenu.grdDataList.DataMember = "dsUser"

                'Setup form title...
                SearchMenu.Text = "User Search"
                ...
                SearchMenu.grdDataList.Columns(5).Width = 180
                SearchMenu.grdDataList.Columns(6).Width = 50

                'Setup column headers...
                SearchMenu.grdDataList.Columns(2).HeaderText = "Last Name"
                SearchMenu.grdDataList.Columns(3).HeaderText = "First Name"
                SearchMenu.grdDataList.Columns(4).HeaderText = "User Name"
                SearchMenu.grdDataList.Columns(5).HeaderText = "E-mail Address"
                SearchMenu.grdDataList.Columns(6).HeaderText = "Status"
            ...
            Case "frmCashierBalancing-cb"
                'frmCashierActivity.cboCashier.DataBindings.Clear()
                frmCashierBalancing.cboCashier.DataSource = objDataSet.Tables("dsUser")
                frmCashierBalancing.cboCashier.DisplayMember = "UserName"
                frmCashierBalancing.cboCashier.ValueMember = "UserName"
        End Select
    ...
    Public Sub subUserAction(ByVal strAction As String, ByVal intUserID As Integer, _
        ...
        If strAction = "SELECT-CASHIER-NUMBER" Then
            frmCashierActivity.intRetCashierRecNbr = Convert.ToInt32(retValParam.Value)
        Else
            frmCashierBalancing.intRetCashierRecNbr = Convert.ToInt32(retValParam.Value)
        End If
        'Close the database connection...
        objConnection.Close()
    ...
    ByVal strBoxNumber As String, ByVal strStatus As String, ByVal strCreateUser As String, ByVal dtCreateDate As Date)
        ...
        Select Case strBindTarget
            ...
            Case "frmSearch"
                'Set the DataGridView properties to bind it to the data...
                SearchMenu.grdDataList.DataSource = objDataSet
                SearchMenu.grdDataList.DataMember = "dsPerson"

                'Setup form title...
                SearchMenu.Text = "Person Search"
                ...
                'Setup column widths...
                SearchMenu.grdDataList.Columns(0).Visible = False
                SearchMenu.grdDataList.Columns(1).Visible = 100
                SearchMenu.grdDataList.Columns(2).Width = 100
                SearchMenu.grdDataList.Columns(3).Width = 100
                SearchMenu.grdDataList.Columns(4).Width = 190
                SearchMenu.grdDataList.Columns(5).Width = 50


                'Setup column headers...
                SearchMenu.grdDataList.Columns(1).HeaderText = "Last Name"
                SearchMenu.grdDataList.Columns(2).HeaderText = "First Name"
                SearchMenu.grdDataList.Columns(3).HeaderText = "Phone"
                SearchMenu.grdDataList.Columns(4).HeaderText = "E-mail Address"
                SearchMenu.grdDataList.Columns(5).HeaderText = "Status"
