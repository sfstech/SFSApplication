...
Public Class clsFAS_JV_Export
    ...
    Public Sub subJVExportSelect(ByVal strBindTarget As String, ByVal strAction As String, ByVal intRowID As Integer, _
                ...
                ByVal dtValidatedDate As Date, ByVal strOrganizationSuffix As String, ByVal strJVType As String)
        ...
        objDataAdapter.SelectCommand.Parameters.AddWithValue("@JVType", strJVType)
        ...
        Select Case strBindTarget
            Case "frmSearch-By-JV", "frmSearch-By-CU"
                ...
                SearchMenu.grdDataList.DataMember = "dsJVExport"

                'Setup form title...
                If strBindTarget = "frmSearch-By-CU" Then
                    SearchMenu.Text = "Journal Voucher Created by Search"
                Else
                    SearchMenu.Text = "Journal Voucher Search"
                End If
                ...
                'Setup column widths...
                SearchMenu.grdDataList.Columns(0).Width = 150
                SearchMenu.grdDataList.Columns(1).Width = 50
                SearchMenu.grdDataList.Columns(2).Width = 50
                ...
                SearchMenu.grdDataList.Columns(0).HeaderText = "JV Name"
                SearchMenu.grdDataList.Columns(1).HeaderText = "Module"
                SearchMenu.grdDataList.Columns(2).HeaderText = "Count"
                SearchMenu.grdDataList.Columns(3).HeaderText = "Total"
                If strAction = "SELECT-BY-UNVERIFIED" Then
                    SearchMenu.grdDataList.Columns(4).HeaderText = "Created By"
                    SearchMenu.grdDataList.Columns(5).HeaderText = "Created On"
                ElseIf (strAction = "SELECT-ALL" Or strAction = "JV-SEARCH-CREATEUSER") Then
                    SearchMenu.grdDataList.Columns(4).HeaderText = "Created By"
                    SearchMenu.grdDataList.Columns(5).HeaderText = "Created On"
                    SearchMenu.grdDataList.Columns(6).HeaderText = "Approved By"
                    SearchMenu.grdDataList.Columns(7).HeaderText = "Approved On"
                    SearchMenu.grdDataList.Columns(8).HeaderText = "Submitted By"
                    SearchMenu.grdDataList.Columns(9).HeaderText = "Submitted On"
                    SearchMenu.grdDataList.Columns(10).HeaderText = "Validated By"
                    SearchMenu.grdDataList.Columns(11).HeaderText = "Validated On"
                Else
                    SearchMenu.grdDataList.Columns(4).HeaderText = "Approved By"
                    SearchMenu.grdDataList.Columns(5).HeaderText = "Approved On"
                End If
            Case "frmJV-Grid"
                'Set the DataGridView properties to bind it to the data...
            ...
            Case "frmJV"
                ...
                frmJV.lblJVType.DataBindings.Clear()
                ...
                frmJV.lblJVType.DataBindings.Add("text", objDataView, "JVType")
            Case "frmJVDataTable"
    ...
    Public Sub subJVExportAction(ByVal strAction As String, ByVal intRowID As Integer, _
                ...
                ByVal strSubmittedUser As String, ByVal dtSubmittedDate As Date, _
                ByVal strckValidated As String, ByVal strValidatedUser As String, _
                ByVal dtValidatedDate As Date, ByVal strOrganizationSuffix As String, _
                ByVal strJVType As String)
        ...
        objCommand.Parameters.AddWithValue("@JVType", strJVType)
    ...
    Public Function fncGetJVBatchNumber(ByVal strBindTarget As String, ByVal strAction As String, ByVal intRowID As Integer, _
                ...
                ByVal strSubmittedUser As String, ByVal dtSubmittedDate As Date, _
                ByVal strckValidated As String, ByVal strValidatedUser As String, _
                ByVal dtValidatedDate As Date, ByVal strOrganizationSuffix As String, ByVal strJVType As String) As String
    ...
    Public Function fncEditCheck(ByVal strAction As String) As Integer
        If strAction = "CreateUser" Then
            ...
            strckManagerVer:="0", strManagerVerUser:="NONE", dtManagerVerDate:="01/01/1900", _
            strckSubmitted:="0", strSubmittedUser:="NONE", dtSubmittedDate:="01/01/1900", _
            strckValidated:="0", strValidatedUser:="NONE", dtValidatedDate:="01/01/1900", strOrganizationSuffix:=frmMainMenu.txtOrganizationSuffix.Text, strJVType:="NONE")
