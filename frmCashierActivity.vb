...
Public Class frmCashierActivity
    ...
    Private Sub frmCashierActivity_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        frmMainMenu.strCallingForm = "Cashier Activity"

        Select Case frmMainMenu.txtModule.Text
            Case "CASHIER-CREATE", "CASHIER-SEARCH-ALL", "CASHIER-SEARCH-BY-DATE", "CASHIER-SEARCH-BY-CASHIER", "CASHIER-SEARCH-BY-AMT", "CASHIER-SEARCH-BY-NOTES"
                subSetSecurityLevel()
        End Select
    ...
    Private Sub subPrintPmtReconReport()
        ...
        Call objReportAction.subReportOpen(intReportID:=0, strReportPath:=frmMainMenu.SFS_PRODUCTION_FOLDER & "rptCashierDailyRecon.rpt", _
